 ...
 * v see why our game manager doesnt run
 * v add dlclose that doesnt ruin the code!
 * v fix our Player - somewhere we override the real position with a guessed one
